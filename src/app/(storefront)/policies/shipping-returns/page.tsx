...
export default function ShippingReturnsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      <h1 className="text-2xl font-bold text-slate-900">Shipping &amp; Returns</h1>
      <div className="mt-6 space-y-5 text-slate-600">
        <section>
          <h2 className="mb-2 text-lg font-semibold text-slate-900">Shipping</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-slate-900">Returns &amp; Exchanges</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-slate-900">Non-Returnable Items</h2>
          <p>
