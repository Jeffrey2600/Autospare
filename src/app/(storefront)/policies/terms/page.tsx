  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="mt-6 space-y-5 text-slate-600">
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-slate-900">Orders &amp; Pricing</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-slate-900">Product Fitment</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-slate-900">Payments</h2>
          <p>
